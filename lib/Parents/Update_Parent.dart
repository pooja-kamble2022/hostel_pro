...
class updateParent extends StatefulWidget {
  ...
  final int parentId;
  @override
  State<updateParent> createState() => _AddStudentState();
}

class _AddStudentState extends State<updateParent> {
  ...
  void initState() {
    ...
    ParentService.getSingleParent(widget.parentId).then((response) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Parent Update Page"),
      ),
      body: Form(
        key: formKey,
